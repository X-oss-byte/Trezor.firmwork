...
#define FLASH_OPTR_VALUE                                                 \
  ((WANT_RDP_LEVEL << FLASH_OPTR_RDP_Pos) | FLASH_OPTR_nRST_STDBY |      \
   ...
   FLASH_OPTR_BKPRAM_ECC | FLASH_OPTR_SRAM2_ECC | FLASH_OPTR_SRAM3_ECC | \
   FLASH_OPTR_TZEN | FLASH_OPTR_SRAM_RST | WANT_BOR_LEVEL)
...
#define FLASH_SECWM1R2_VALUE \
  (FLASH_SECWM1R2_HDP1_PEND_Pos | FLASH_SECWM1R2_HDP1EN | 0x7F007F00)
